const KEY_POINTS: Record<string, { x: number; y: number; w?: number; h?: number }> = {
  Digit1: { x: 23.0, y: 58.0 },
  Digit2: { x: 28.3, y: 58.0 },
  Digit3: { x: 33.1, y: 58.0 },
  Digit4: { x: 37.7, y: 58.0 },
  Digit5: { x: 42.3, y: 58.0 },
  Digit6: { x: 46.9, y: 58.0 },
  Digit7: { x: 51.5, y: 58.0 },
  Digit8: { x: 56.1, y: 58.0 },
  Digit9: { x: 60.8, y: 58.0 },
  Digit0: { x: 65.4, y: 58.0 },
  Minus: { x: 70.0, y: 58.0 },
  Equal: { x: 74.4, y: 58.0 },
