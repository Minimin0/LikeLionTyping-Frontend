      ...
      <header className="border-b border-zinc-200 bg-white">
        <div className="mx-auto flex min-h-16 max-w-5xl items-center justify-between px-4">
          ...
          <nav aria-label="주요 메뉴" className="flex items-center gap-1">
            {/* 참가자 화면은 팀원이 별도로 작업 중이라 이 브랜치엔 실제 라우트가 없다.
                자리만 남겨두는 라벨이라 항상 표시하고 링크로 만들지 않는다. */}
      ...
      <main className="mx-auto max-w-3xl px-4 py-8 sm:py-12">
        ...
        <RouteErrorBoundary>
          <Routes>
            ...
            {/* 참가자 화면(랜딩/참가/카테고리/게임/결과)은 팀원이 별도로 새로 작업 중이라
                이 브랜치에는 두지 않는다. 정의되지 않은 경로는 전부 운영자 화면으로 보낸다. */}
